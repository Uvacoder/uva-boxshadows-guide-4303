<template>
  <div class="grid layout h-screen">
    ...
    <section class="sidebar sidebar-right border-l border-gray-300 p-4">
      ...
      <RangeInput v-model="borderRadius" unit="rem" label="Border radius" min="0" max="20" />
      <RangeInput v-model="boxHeight" unit="rem" label="Height" min="0" max="40" />
      <RangeInput v-model="boxWidth" unit="rem" label="Width" min="0" max="40" />
    </section>
